...
const Countries = ({ getTheWorld }) => {
  return (
    <div className="sm:grid sm:grid-cols-4 gap-[60px] sm:items-start items-center flex flex-col justify-center pb-[50px]">
      {getTheWorld.map((country) => {
        return (
          <Link
            ...
            key={country.name}
            state={{ country }}
            className="shadow-md text-start rounded-md sm:w-[275px] bg-elements"
          >
            <img
